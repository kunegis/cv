...
\begin{itemize}
  ...
  \item[{[T10]}] 
    ...
    \href{https://www.slideshare.net/kunegis/eight-ways}{Eight Formalisms for Defining Graph Models.}  Univ.\ of Koblenz--Landau, 2013. 
  \item[{[T11]}] Growth and Decay: Using Machine Learning to Predict the Web's
    Future, Workshop on Artif.\ Intell.\ on the Web, 2012. 
  \item[{[T12]}] Models of Like, Dislike, Similarity and Dissimilarity using
  ...
  \item[{[T14]}] Fairness on the Web: Alternatives to the Power
    Law. 
    Leibniz-Institut für Sozialwissenschaften, Cologne, 2012.  
  \item[{[T15]}] On the Spectral Evolution of Large Networks.  Univ.\ Coll.\ Cork, 2011.   
  \item[{[T16]}] On the Spectral Evolution of Large Networks.  Fraunhofer IAIS,
    St.\ Augustin, 2011.  
  \item[{[T17]}] On the Spectral Evolution of Large Networks. Technical
    Univ.\ of Berlin, 2011.  
  ...
  \item[{[T21]}] PIA+COMM~-- an Intelligent Search Engine.
...
\begin{itemize}
  \item[{[T22]}] Linguistic Neighbourhoods: Explaining Cultural Borders on
  ...
  \item[{[T23]}] Challenges in Mining Social Media: Sparsity and Quality.
...
\begin{itemize}
 \item[{[D1]}] Schülerinformationstage, Institute for Web Science and
...
\begin{itemize}
  \item
    \marginnote{\href{https://github.com/kunegis/stu}{\faCode} \href{https://networkscience.wordpress.com/2016/04/01/stu-build-automation-for-data-mining-projects/}{\faChain}}
