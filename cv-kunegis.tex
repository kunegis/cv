...
\item \href{http://www.connected-living.org/}{Connected Living} (Innovationszentrum ``Vernetztes Leben'') \hfill 2009--2010
...
\section{Lecturing}
\begin{itemize}
\item Graph Theory (Théorie des graphes, in French), Mathematics (BSc), Univ.\ of Namur, Winter Term, 2017/2018. 
\item Network Theory and Dynamic Systems, Web Science (MSc), Univ.\ of Koblenz--Landau, Summer Term 2014, 2015, 2016.  
\item Introduction to Database Systems (Grundlagen der Datenbanken, in German), Computer Science (BSc), Univ.\ of Koblenz--Landau,
