...
\begin{itemize}
  ...
  \item \textbf{Programming languages:}
    Major work performed in:  C (C90, C99), C++ (experience with C++98, C++14,
    C++20), Java (SE~6), Matlab (2009), Perl~(5), Python~(3), shell
  ...
  \item \textbf{Build systems and continuous integration/delivery (CI/CD):}
    Ant, Autotools/Autoconf/Automake, Cook, Jenkins, Make, Maven, Stu (I am the
    author). 
  ...
  \item \textbf{Query, data processing and representation technologies:}
    CSV, RDF, relational databases, sed, SQL, XSLT. 
...
\begin{itemize}
\item \textbf{CREST over SwiftNet} \hfill 2023--present \\
