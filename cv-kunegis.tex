...
\name{
  \hspace{3.95cm} Dr.\ Jérôme KUNEGIS \hfill
...
\section{Positions}
\begin{itemize}
\item[] \textbf{Senior Dev/Systems Engineer} \hfill 2025--present \\
  Society for Worldwide Interbank Financial Telecommunication
\item[] \textbf{Dev/Systems Engineer} \hfill 2023--2025 \\
  Society for Worldwide Interbank Financial Telecommunication
...
\begin{itemize}
  \item
    ...
    \href{https://github.com/kunegis/stu}{Stu}, build automation (C++17)
  \item 
...
\begin{itemize}
  \item
    \marginnote{
      \href{https://websci26.org/?page_id=897}{\faStar}
      \href{http://dl.acm.org/citation.cfm?id=2527052}{\faFileTextO}
      \href{https://www.slideshare.net/kunegis/bad-news-travel-fast-a-contentbased-analysis-of-interestingness-on-twitter}{\faSlideshare}
      }
    Test of Time Award, Web Sci.\ Conf.\ (WebSci), 2026.
  \item
    \marginnote{
      \href{https://sites.google.com/site/icwsmscienceslam/}{\faStar}
      \href{https://www.slideshare.net/kunegis/science-slam-by-jrme-kunegis-icwsm-2016}{\faSlideshare}
  ...
  \item 
    ...
    Best Poster Award, Int.\ Sch.\ and Conf.\ on Netw.\ Sci.\ (NetSciX), 2016. 
  \item 
...
\begin{itemize}
  ...
  \item \textbf{Programming languages:}
    ...
    scripting (POSIX, Bash, KSH);
    work performed in: Ada, AWK, BASIC, JavaScript, Julia, Logo, Object Pascal, Octave,
    PHP, Turbo Pascal, Tcl. 
  \item \textbf{Operating systems:}
    Major work performed on: GNU/Linux (Ubuntu, Red Hat), Windows, AIX; work
    performed on: Solaris, FreeBSD, macOS.  
  \item \textbf{Source code management and methodologies:}
    CVS, Git, Kanban, Subversion/SVN. 
  \item \textbf{Build systems and continuous integration/delivery (CI/CD):}
    Ant, Autotools/Autoconf/Automake, CMake, Conan, Cook, Jenkins, Make, Maven, Stu (I am
    the author).
