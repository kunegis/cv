...
\name{\hspace{3.3cm}{\normalfont Dr.\ rer.\ nat.\ Dipl.-Inform.}\ Jérôme KUNEGIS \hspace{1.5cm}{\normalfont (Complete CV)}}
\begin{resume}
...
\item Stephan Spiegel.  A Hybrid Approach to Recommender Systems based
  on Matrix Factorization, \emph{Dipl.-Inform.}, Tech.\ Univ.\ of
  Berlin, 2009.  
\item Christian Banik.  Recommending Wiki Articles using Collaborative
  Filtering, \emph{Dipl.-Inform.}, Tech.\ Univ.\ of Berlin, 2009. 
\item Iris Breddin.  Untersuchung der Klassifizierbarkeit und
  Klassifikation von Schweißnahtdaten, \emph{Dipl.-Inform.}, Tech.\ Univ.\ of Berlin, 2008.    
\end{itemize}
...
\begin{itemize}
  ...
  \item[{[T9]}] Observing the Web: The Koblenz Network Collection.
  ...
  \item[{[T11]}] 
    ...
    Workshop on Modeling Linguistic Networks, 2012. 
  \item[{[T12]}] Growth and Decay: Using Machine Learning to Predict the Web's
    Future, Workshop on Artif.\ Intell.\ on the Web, 2012. 
  \item[{[T13]}] Models of Like, Dislike, Similarity and Dissimilarity using
  ...
  \item[{[T15]}] Fairness on the Web: Alternatives to the Power
    Law. 
  ...
  \item[{[T17]}] On the Spectral Evolution of Large Networks.  Univ.\ Coll.\ Cork, 2011.   
  \item[{[T18]}] On the Spectral Evolution of Large Networks.  Fraunhofer IAIS,
    St.\ Augustin, 2011.  
  \item[{[T19]}] On the Spectral Evolution of Large Networks. Tech.\ Univ.\ of Berlin, 2011.  
  \item[{[T20]}] The Slashdot Zoo: Mining a Social Network with Negative
    Edges. Data and Knowl.\ Engineering Research Colloquium,
    Otto von Guericke Univ.\ Magdeburg, 2010.  
  \item[{[T21]}] The Slashdot Zoo: Mining a Social Network with Negative
    Edges. Univ.\ of Koblenz--Landau, 2010. 
  \item[{[T22]}] The Slashdot Zoo: Mining a Social Network with Negative
    Edges. Univ.\ of Hannover, 2010. 
  \item[{[T23]}] PIA+COMM~-- an Intelligent Search Engine.
...
\begin{itemize}
  \item[{[T24]}] Linguistic Neighbourhoods: Explaining Cultural Borders on
  ...
  \item[{[T25]}] Challenges in Mining Social Media: Sparsity and Quality.
...
\begin{itemize}
  \item[{[P1]}] Linguistic Neighbourhoods:  Explaining Cultural Borders on
    ...
    2016. 
  \item[{[P2]}]
    \marginnote{\href{https://github.com/kunegis/pdfs/blob/master/kunegis:stu-poster.pdf}{\faObjectGroup}}
    Do You Use Stu? Soon, You'll Do.
    Jérôme Kunegis, 
    WeST Institute Off-Campus Meeting (OCM), 2016. 
  \item[{[P3]}]
    \marginnote{\href{https://github.com/kunegis/pdfs/blob/master/kunegis:social-network-observatory.poster.pdf}{\faObjectGroup}}
  ...
  \item[{[P9]}] 
    ...
    Symp.\ (CSSWS), 2014.
  \item[{[P10]}]
    \marginnote{\href{https://github.com/kunegis/pdfs/blob/master/kunegis:konect-poster-2013.pdf}{\faObjectGroup}}
  ...
  \item[{[P14]}]
    \marginnote{\href{https://github.com/kunegis/pdfs/blob/master/kunegis:phd.poster.pdf}{\faObjectGroup}}
    On the Spectral Evolution of Large Networks. Postersession 
    für Nachwuchswissenschaftler/innen, Univ.\ of Koblenz--Landau,
    2011. 
  \item[{[P15]}]
    \marginnote{\href{https://github.com/kunegis/pdfs/blob/master/kunegis:sdm2010.poster.pdf}{\faObjectGroup}}
...
\begin{itemize}
  \item
    \marginnote{\href{https://www.youtube.com/watch?v=OxwsmNp3LFw}{\faVideoCamera} \href{https://www.slideshare.net/kunegis/science-slam-by-jrme-kunegis-icwsm-2016}{\faSlideshare}}
