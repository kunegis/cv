...
\name{\hspace{4.1cm}{\normalfont Dr.\ rer.\ nat.\ Dipl.-Inform.}\ Jérôme KUNEGIS\footnote{
    Legend:  ~
    ...
    \faChain~Publication has an accompanying website ~~
    \faDatabase~Dataset is available ~~
    \faCog~Source code is available ~~
    \faVideoCamera~Video is available ~~
    \faNewspaperO~Publication has media coverage ~~
    \faStar~Publication has won a prize ~~
    \faStarO~Publication was nominated for a prize 
...
\begin{itemize}
  ...
  \item[{[T17]}] Growth and Decay: Using Machine Learning to Predict the Web's
    Future, Workshop on Artif.\ Intell.\ on the Web, 2012. 
  \item[{[T18]}] Models of Like, Dislike, Similarity and Dissimilarity using
  ...
  \item[{[T20]}] Fairness on the Web: Alternatives to the Power
    Law. 
  ...
  \item[{[T22]}] On the Spectral Evolution of Large Networks.  Univ.\ Coll.\ Cork, 2011.   
  \item[{[T23]}] 
  ...
  \item[{[T24]}] On the Spectral Evolution of Large Networks.  Fraunhofer IAIS,
    St.\ Augustin, 2011.  
  \item[{[T25]}] On the Spectral Evolution of Large Networks. Tech.\ Univ.\ Berlin, 2011.  
  ...
  \item[{[T28]}] The Slashdot Zoo: Mining a Social Network with Negative
