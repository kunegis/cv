...
\begin{itemize}
  ...
  \item[{[T15]}] Growth and Decay: Using Machine Learning to Predict the Web's
    Future, Workshop on Artif.\ Intell.\ on the Web, 2012. 
  \item[{[T16]}] Models of Like, Dislike, Similarity and Dissimilarity using
  ...
  \item[{[T18]}] Fairness on the Web: Alternatives to the Power
    Law. 
  ...
  \item[{[T20]}] On the Spectral Evolution of Large Networks.  Univ.\ Coll.\ Cork, 2011.   
  \item[{[T21]}] 
  ...
  \item[{[T22]}] On the Spectral Evolution of Large Networks.  Fraunhofer IAIS,
    St.\ Augustin, 2011.  
  \item[{[T23]}] On the Spectral Evolution of Large Networks. Tech.\ Univ.\ of Berlin, 2011.  
  \item[{[T24]}] The Slashdot Zoo: Mining a Social Network with Negative
...
\begin{itemize}
  \item[{[T28]}] Linguistic Neighbourhoods: Explaining Cultural Borders on
  ...
  \item[{[T29]}] Challenges in Mining Social Media: Sparsity and Quality.
